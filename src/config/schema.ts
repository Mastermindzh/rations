...
export const IMAGE_PATTERN = /^[^/\\]+\.(?:jpe?g|png|webp|avif)$/i;
  ...
  people: z.record(
    ...
    z.strictObject({
      ...
      image: z
        .string()
        .refine(
          (value) => IMAGE_PATTERN.test(value) && !value.includes(".."),
          "Must be a filename with a jpg, jpeg, png, webp, or avif extension",
        )
        .optional(),
    }),
  ),
